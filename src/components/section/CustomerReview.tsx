...
const CustomerReview: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto py-12 px-8 md:px-0">
      <Section
        icon={GoCodeReview}
      ...
      <Carousel autoplay dotPosition="bottom" effect="fade">
        {reviewsData.map((review) => (
          <div 
            key={review?.id} 
            className="carousel-slide bg-gray-50 shadow-lg rounded-lg overflow-hidden"
          ...
          >
            <div className="p-6 flex items-center">
              ...
              />
              <div data-aos="fade-left"> {/* Animation for the text */}
            ...
            <div className="p-6 border-t border-gray-200">
              <p className="text-gray-700 text-base italic" data-aos="fade-up">
                "{review?.text}"
              </p>
            </div>
          </div>
