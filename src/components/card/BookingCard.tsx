        ...
        <div className="relative border border-gray-200 p-4 sm:p-6 rounded-xl">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start">
                <div className="mb-4 sm:mb-0">
                    <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-2"> {booking?.room.name}</h2>
                    <p className="text-gray-600">
                        <strong>Date:</strong> {booking?.date}</p>
                    <p className="text-gray-600">
                        <strong>Bookings Status:</strong> {renderStatus()}
                    </p>
                    <p className="text-gray-600 ">
                ...
                {booking?.isConfirmed === "unconfirmed" ? (
                    ...
                    <div>
                        <p className="text-lg font-bold text-gray-700 m-0 md:m-auto">
                ...
                <div className="space-y-4 mt-4">
                    {booking?.slots.length > 0 ? (
                        booking.slots.map((slot: TSlot) => (
                            <div
                                key={slot?._id}
                                className="flex flex-col sm:flex-row my-auto justify-between items-center bg-zinc-200 p-3 rounded-lg"
                            >
