    ...
    <Layout >
      ...
      >
        <div className="">
          <div className="text-center text-white p-3 font-Nunito flex flex-col md:flex-row justify-center items-center">
            <span className='bg-slate-800 px-10 py-2 text-lg rounded-xl'>Nexus Reserve</span>
          </div>
        </div>
      ...
      <Layout >
        <Header className="bg-white shadow-md flex justify-between items-center px-4">
          <div className="text-lg md:text-3xl p-4 md:p-0 mx-auto font-semibold text-gray-800" style={{ fontFamily: 'Nunito' }}>
            Admin Dashboard
          </div>
