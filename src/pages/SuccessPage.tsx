    ...
    <div>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen">
        <div className=" mx-auto text-center bg-white p-8 rounded-lg shadow-lg">
          ...
          <p className="mt-4 text-lg text-gray-700">Your order has been placed successfully. Thank you for shopping with us!</p>
          <p className="mt-4 text-sm text-gray-500">You will receive a confirmation email with your order details shortly.</p>
          <Link
            to="/"
