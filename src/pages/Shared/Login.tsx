            ...
            <div className="flex flex-col items-center w-full max-w-lg bg-white/80 backdrop-blur-md rounded-lg shadow-lg p-4 md:p-8">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 w-full">
                    ...
                    <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                        Don’t have an account yet? <Link to="/signup" className="font-medium text-primary-600 hover:underline dark:text-primary-500"><span className='text-blue-600 font-bold'>Sign up</span></Link>
                    </p>
                </form>
            </div>
        </div>
